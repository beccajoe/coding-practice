...
public class Login {
    public String solution(String[] id_pw, String[][] db) {
        ...
        for (String[] s : db){
            ...
            String currentPw = s[1];
            if (id.equals(currentId) && pw.equals(currentPw)){
                answerList.add("login");
            } else if (id.equals(currentId)){
                answerList.add("wrong pw");
            }
        }
        if (answerList.contains("login")){
            answer = "login";
        } else if (answerList.contains("wrong pw")){
            answer = "wrong pw";
        } else {
            answer = "fail";
        }
