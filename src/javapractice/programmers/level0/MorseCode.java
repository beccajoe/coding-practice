        ...
        for (String s : stringArray){
            switch (s){
                ...
                case "-..-":
                    ...
                    break;
                case "-.--":
                    answerBuilder.append("y");
                    break;
                case "--..":
                    answerBuilder.append("z");
                    break;
            }
        }
        String answer = String.valueOf(answerBuilder);
        return answer;
    }
}
// 모스부호 (1)
